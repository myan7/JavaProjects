...
public class EASY_1920_BuildArrayfromPermutation {


    // Can you solve it without using an extra space (i.e., O(1) memory)?
    // Runtime: 1 ms, faster than 95.07% of Java online submissions for Build Array from Permutation.
    // Memory Usage: 42.4 MB, less than 87.10% of Java online submissions
    ...
    // initial solution Runtime: 1 ms, faster than 95.07% of Java online submissions
    // T: O(N) ; S: O(N)
