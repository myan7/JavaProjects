...
/* also check LC 678 Valid Parenthesis String
 ...
 */
public class MEDIUM_2116_CheckifaParenthesesStringCanBeValid {
    public boolean canBeValid(String s, String locked) {
        ...
        for(int i=0; i<len; i++) {
            ...
            if(locked.charAt(i) == '0' || s.charAt(i) == '(')
                ...
                balance--;     // otherwise, decrement balance, since it is ) and also locked
