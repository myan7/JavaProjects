...
denoting whether the ith car is moving towards the left, towards the right,
or staying at its current point respectively.
 ...
 */
public class WC285_6028_CountCollisionsonaRoad {
    ...
    public static void main(String[] args)
    {
        String s = "RLRSLL";  //5
        s = "RSLLRSSL";  // 5
        s = "LLRLRLLSLRLLSLSSSS"; //10
        s = "SSRSSRLLRSLLRSRSSRLRRRRLLRRLSSRR"; // 20
        int count = countCollisions(s);
