...
/*
An infrastructure consisting of n cities from 1 to n,
and m bidirectional roads between them are given.
...
For each pair of cities directly connected by a road,
let’s define their network rank as the total number of roads that are connected to either of the two cities.

Write a function, given two arrays starts, ends consisting of m integers each and an integer n,
where starts[i] and ends[i] are cities at the two ends of the i-th road,
...
public class MS_OA_002_MaxNetworkRank {
